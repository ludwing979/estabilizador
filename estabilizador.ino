    ...
    if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
        ...
        fifoCount -= packetSize;
            ...
            if (euler[2] * 180/M_PI >= -90 && euler[2] * 180/M_PI <= 90){
              sm_x.write(euler[2] * 180/M_PI + 90);
            }
            Serial.print(euler[2] * 180/M_PI + 90);
            
            Serial.print("\ty: ");
            if (euler[1] * 180/M_PI >= -90 && euler[1] * 180/M_PI <= 90){
              sm_y.write(euler[1] * 180/M_PI + 90);
            }
            Serial.print(euler[1] * 180/M_PI + 90);

            Serial.print("\tz: ");
            if (euler[0] * 180/M_PI >= -90 && euler[0] * 180/M_PI <= 90){
              
            }
            Serial.print(euler[0] * 180/M_PI + 90);
